...
|                         | **Before**                                          | **After**                                                                                               |
| ----------------------- | --------------------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| **SSG**                 | [Next.js v14.2.4](https://nextjs.org/)              | [Astro 5.74](https://astro.build/)                                                                      |
...
Next.js was never a sensible choice (from a page size perspective) for a small, static, personal site. This comparison isn't meant to imply Next.js is bad or slow or bloated or anything. Next.js just was something I was playing with and I'm now playing with Astro.
