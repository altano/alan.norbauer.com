...
{/* prettier-ignore */}
<Callout>⚠️ This article was originally published in 2005 at [dubi.org/link-checker](https://web.archive.org/web/20061026132329/http://dubi.org/link-checker). The content is extremely outdated and is preserved here for nostalgic purposes only.</Callout>

Takes a URL on the command line and outputs a list of contained links and their validity:

```php title=link-checker.php
<?php
/*
