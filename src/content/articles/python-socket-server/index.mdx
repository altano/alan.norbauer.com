...
{/* prettier-ignore */}
<Callout>⚠️ This article was originally published in 2005 at dubi.org/python-socket-server-for-flash. The content is extremely outdated and is preserved here for nostalgic purposes only.</Callout>
