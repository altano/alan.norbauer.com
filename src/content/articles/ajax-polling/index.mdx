...
import AjaxPollingExampleViewer from "./AjaxPollingExampleViewer.astro";

<Callout>
  ⚠️ This article was originally published in 2005 at
  [dubi.org/ajax-polling](https://web.archive.org/web/20061129151134/http://dubi.org/ajax-polling).
...
Below you can browse the example code demonstrating these concepts. You can also download the [source code](/articles/ajax-polling/xmlhttprequest.zip). Feel free to use the source code in any way you wish.

<AjaxPollingExampleViewer />
