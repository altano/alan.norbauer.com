...
tags:
  ...
  - vcs
  - github
date_updated: 2026-08-14T19:47:42.569Z
---
...
1. Reorder your commits locally, however you want (e.g. `jj arrange`):
   ...
   <JJStack
     ...
     command="jj arrange"
     caption="Swapping the middle two commits. Each bookmark follows its commit, so the stack is now `bookmark-1 bookmark-3 bookmark-2 bookmark-4`, bottom-up."
   />
...
Why is reordering commits so fucking complicated, you ask? Why can't you just reorder your commits and run `jj git push -r "stack()"`?

Needed terminology, [in GitHub parlance](https://docs.github.com/en/rest/pulls/pulls):
