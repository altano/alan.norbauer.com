...
date_updated: 2025-04-27T06:07:52.374Z
...
![Cursor hovers the `title` field in the GraphQL fragment, showing a tooltip with the GraphQL schema  description for that field](/articles/relay-style-graphql/issueTitle.tsx.gif)
