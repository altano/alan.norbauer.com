...
Over on [lobste.rs](https://lobste.rs/) someone submitted a great site, [getoutofmyhead.dev](https://getoutofmyhead.dev/), made by [Nathaniel](https://endtimes.dev/about/). His pitch is:
